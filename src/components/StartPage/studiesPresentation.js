      ...
      <section>
        ...
        <div className="skillsContainer">
          <div className="textBox">
            ...
            <p>Full-time 12 w boot camp / intensive program. Covering everything from
            ...
            companies like Volumental, Bonnier, Comprend and Svenska Spel. <br />
            Stockholm, September - November 2018
            </p>
          </div>
          <div className="textBox">
            <h4>Media and communication studies</h4>
            <p>At Stockholm University (JMK, Department of Media Studies, Section for Journalism, Media and Communication) 2009-2012.
            </p>
          </div>
          <div className="textBox">
            <h4>Other</h4>
